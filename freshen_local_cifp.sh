...
set +e
wget --recursive -l1 --span-hosts --domains=aeronav.faa.gov,www.faa.gov --timestamping --no-parent -A.zip -erobots=off http://www.faa.gov/air_traffic/flight_info/aeronav/digital_products/cifp/download/
set -e
